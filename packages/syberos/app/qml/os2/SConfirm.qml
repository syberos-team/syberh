...
CAbstractPopLayer{
   ...
   */
   ...
   /*! 标题左侧 warning icon */
   property string warningIcon: "qrc:/res/warning.png"

   /*! 标题左侧 success icon */
   property string successIcon: "qrc:/res/success_primary.png"

   /*! 无标题 大 warning icon */
   property string warningBigIcon: "qrc:/res/warning_big.png"

   /*! 无标题 大 success icon */
   property string successBigIcon: "qrc:/res/success_primary_big.png"
