...
module.exports = {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin([
            {
                // copy到cli/templates/default/lib/syber.min.js
                from: Path.resolve(__dirname, './dist/syber.min.js'),
                to: Path.join(
                    Path.dirname(Path.resolve(__dirname)),
                    'syberos-cli/templates/default/lib/syber.min.js',
                ),
            },
            {
                from: Path.resolve(__dirname, './dist/syber.min.js'),
                to: Path.join(
                    Path.dirname(Path.resolve(__dirname)),
                    'syberos-template/app/www/lib/syber.min.js',
                ),
            },
        ]),
    ],
