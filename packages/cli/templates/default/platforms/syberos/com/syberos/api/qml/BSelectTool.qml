...
Item {
    ...
    Image{
        ...
        source: "qrc:/com/syberos/api/qml/CMenu/pics/startHandleUp.png"
    ...
    Image{
        ...
        source: "qrc:/com/syberos/api/qml/CMenu/pics/endHandle.png"
    ...
    Image{
        ...
        source: cusror1.pressed?"qrc:/com/syberos/api/qml/CMenu/pics/startHandleUp.png":"qrc:/com/syberos/api/qml/CMenu/pics/endHandle.png"
    }
