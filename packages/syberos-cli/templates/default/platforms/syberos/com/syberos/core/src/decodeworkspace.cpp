...
DecodeWorkSpace::DecodeWorkSpace(QObject *parent):QObject(parent)
{
    ...
    m_pCamera = QtCameraScan::getInstance();
    qDebug() << "DecodeWorkSpace::DecodeWorkSpace QtCameraScan::getInstance" << m_pCamera;
...
DecodeWorkSpace::~DecodeWorkSpace(){
    ...
    if(m_pCamera->status() == QtCameraScan::ActiveStatus){
        qDebug() << "m_pCamera->status() == QtCameraScan::ActiveStatus--------------- stopCamera ";
